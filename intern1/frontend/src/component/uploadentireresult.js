...
export default function Uploadentireresult(){
  ...
  const result = await axios.post('http://localhost:3001/uploadentireresult', formData, { headers: {'Content-Type': 'multipart/form-data'}})
