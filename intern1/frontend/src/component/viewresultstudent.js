...
export default function Viewresultstudent(){
  ...
  const result = await axios.post('http://localhost:3001/viewresultstudent', formData, { headers: {'Content-Type': 'application/json;charset=UTF-8'}})
