...
export default function Deleteclassa(){
  ...
  const result = await axios.post('http://localhost:3001/deleteclassa', formData, { headers: {'Content-Type': 'application/json;charset=UTF-8'}})
  console.log(result)
    ...
    return(
        ...
        {username?<><h1>hello{username}</h1>
            <form onSubmit={sumit}>
                ...
                <input type='text' onChange={(e)=>setTname(e.target.value)} placeholder="enter teachername"></input>
