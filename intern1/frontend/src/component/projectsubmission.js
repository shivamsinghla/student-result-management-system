...
export default function Projectsubmission(){
  ...
  const result = await axios.post('http://localhost:3001/projectsubmission', formData, { headers: {'Content-Type': 'multipart/form-data'}})
  if(result.data.status=="success"){
    ...
    return(
      ...
      <div className={styles.formContainer}>
        <h1>Upload Project submission Data</h1>
        <form onSubmit={sumit}>
